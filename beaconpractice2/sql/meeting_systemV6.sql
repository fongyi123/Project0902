...
CREATE TABLE IF NOT EXISTS `meet` (
  ...
  `create1` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
`id` int(11) NOT NULL
...
INSERT INTO `meet` (`select_meet`, `meetdate1`, `meetdate2`, `meettheme`, `meetlocation`, `meettowner`, `meetfile`, `create1`, `id`) VALUES
('3', '2016-01-01', '2016-01-01', '會議簽到', 'L405', 'STUST', 'C:fakepath', 'Array', 11),
('', '0000-00-00', '0000-00-00', '', '', '', '', '', 12);
