...
-- 資料表結構 `meet`
--
-- 建立時間: 2016 年 09 月 08 日 09:04
--

DROP TABLE IF EXISTS `meet`;
CREATE TABLE IF NOT EXISTS `meet` (
  `select_meet` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `meetdate1` date NOT NULL,
  `meetdate2` date NOT NULL,
  `meettheme` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `meetlocation` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `meettowner` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `meetfile` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `meet` (`select_meet`, `meetdate1`, `meetdate2`, `meettheme`, `meetlocation`, `meettowner`, `meetfile`, `create`, `id`) VALUES
('1', '2016-09-13', '2016-09-12', '1', '1', '1', '1', '1', 1),
('1', '2016-09-13', '2016-09-10', '1', '1', '1', '1', '1', 2),
('1', '2016-09-13', '2016-09-10', '1', '1', '1', '1', '1', 3),
('4', '2016-09-01', '2016-09-02', '4', '4', '4', '4', '', 4),
('4', '2016-09-01', '2016-09-02', '4', '4', '4', '4', '4', 5);
...
('us0001', 'ben', '1', '女', '執行長', '1', 'dep01', 'QQ', 'QQ'),
