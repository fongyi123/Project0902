...
<?php
	...
	//資料搜尋成功
	$sql = "SELECT * FROM Meeting, Sign ,users WHERE Sign.userID ='" .  $_POST['userID'] .  "' and Meeting.meetingID=Sign.meetingID and users.username='" . $_POST['uidname'] .  "' ORDER BY `users`.`depID` ASC";
